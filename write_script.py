...
path = r"C:\Users\merta\Desktop\Spring Cloud Microservices\spring-cloud-microservices-mastery\test-eureka-health.ps1"
with open(path, "w", encoding="utf-8-sig") as f:
    f.write(content)
print("test-eureka-health.ps1 olusturuldu:", path)
